...
3. Click **Speak** to start playback, **Stop** to cancel.

## Requirements

A browser that supports the [Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API) (Chrome, Edge, Safari, Firefox).
